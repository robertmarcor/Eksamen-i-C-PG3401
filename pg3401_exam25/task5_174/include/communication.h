...
void ewp_init_helo_response(void *response, const char *client_id);

// Initialize a response to MAIL FROM
void ewp_init_mail_from_response(void *response);

// Initialize a response to RCPT TO
void ewp_init_rcpt_to_response(void *response);

// Initialize a DATA command response
void ewp_init_data_response(void *response, int is_valid_filename);

// Initialize a QUIT response
void ewp_init_quit_response(void *response, const char *server_id);
